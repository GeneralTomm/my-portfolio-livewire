                                ...
                                <table class="w-full text-left whitespace-no-wrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="px-2 py-3 text-sm">{{ $category->name }}</td>
                                            <td class="px-2 py-3 text-sm">{{ $category->slug }}</td>
                                            <td class="px-2 py-3 text-sm text-gray-900">
                                                ...
                                                @if ($confirmation === $category->id)
                                                {{-- hapus --}}
                                                <button wire:click="deleted({{ $category->id }})" class="bg-red-500 px-2 py-1 text-white">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                ...
                                                @else
                                                {{-- konfirmasi hapus --}}
                                                <button wire:click="confirmationDeletedId({{ $category->id }})"
