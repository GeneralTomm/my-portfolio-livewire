<aside class="flex flex-col items-center bg-white text-gray-700 shadow h-full">
    ...
    <ul>
        ...
        <li class="hover:bg-gray-100">
            <a href="{{route('dashboard')}}" class="h-16 px-6 flex justify-center items-center w-full
        ...
        <li class="hover:bg-gray-100">
            <a href="{{route('kategori-blogs.index')}}" class="h-16 px-6 flex justify-center items-center w-full
					focus:text-orange-500">
                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="mt-auto h-16 flex items-center w-full justify-center">
        <!-- Action Section -->
        <form method="POST" action="{{ route('logout') }}">
            @csrf
        <a :href="route('logout')"  onclick="event.preventDefault(); this.closest('form').submit();"
            class="h-16 hover:cursor-pointer  w-10 mx-auto flex  justify-center items-center  focus:text-orange-500 hover:bg-red-200 focus:outline-none">
