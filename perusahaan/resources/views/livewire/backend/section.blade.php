    ...
    <div class="mx-auto md:px-4 px-6 lg:px-8 -4 m-3">
        <div class="flex">
            <div class="mt-5 md:mt-0 md:col-span-2 w-full">
                ...
                @if ($isModalOpen)
                @include('livewire.modal.modal-section')
                @endif
                                ...
                                <table class="w-full text-left whitespace-no-wrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="px-2 py-3 text-sm">{{ $section->section }}</td>
                                            <td class="px-2 py-3 text-sm text-gray-900">
                                                ...
                                                @if ($konfirmasi === $section->id)
                                                {{-- hapus --}}
                                                <button wire:click="hapus({{ $section->id }})" class="bg-red-500 px-2 py-1 text-white">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                ...
                                                {{-- batal --}}
                                                <button wire:click="batalMenghapus()"
                                                ...
                                                @else
                                                {{-- konfirmasi hapus --}}
                                                <button wire:click="konfirmasiHapusId({{ $section->id }})"
                                        ...
                                        @else
                                        <tr>
                                            <td class="text-center" colspan="3">Tidak ada Section</td>
                                        </tr>
                                        @endif
                                    </tbody>
                                </table>
