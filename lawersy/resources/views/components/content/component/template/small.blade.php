<div class="py-5">
    <div class="bg-white rounded-md" x-data="{previews : 'preview',
        ...
        <div class="border-table">
            <span class="border-table-span">Small</span>
        ...
        <div>
            <div x-show="previews === 'preview'" class="p-4">
                <div class="overflow-y-auto">
                    @include('components.content.component.badge.result.small')
                </div>
            </div>
            <div x-show="previews === 'code'" class="p-4">
                <pre class="language-html dark:text-black overflow-y-scroll"><code>@include('components.content.component.badge.code.small')</code></pre>
            </div>
        </div>
