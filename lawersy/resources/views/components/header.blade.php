        ...
        <div class="flex gap-3 justify-between items-center">
            <div class="flex gap-2 items-center">
                <button class="lg:hidden" @click.away="sidebar = !sidebar">
                    ...
                    <a href="/" class="lg:h1-version-normal h1-version-small">
                        <span class="uppercase tracking-widest">Lowersy</span>
                    </a>
            </div>
            <div class="flex gap-4 items-center">
                <a href="#" class=" dark:bg-gray-900 dark:hover:bg-gray-500 hover:bg-gray-900 hover:text-white bg-white shadow-md rounded-md p-2">
                    ...
                    x-on:click.away="open = !open">
                        <div class=" w-52">
                            <div class="grids">
                                ...
                                <a href="#" class=" flex items-center gap-3 dark:bg-gray-900 dark:hover:bg-gray-500 hover:bg-gray-900 hover:text-white bg-white shadow-md rounded-md p-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                                    </svg>
                                    <span class="lg:text-sm text-base">Code Editor</span>
                                </a>
                                <a href="#" class=" flex items-center gap-3 dark:bg-gray-900 dark:hover:bg-gray-500 hover:bg-gray-900 hover:text-white bg-white shadow-md rounded-md p-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    <span class="lg:text-sm text-base">Web Builder</span>
                                </a>
                                <a href="#" class=" flex items-center gap-3 dark:bg-gray-900 dark:hover:bg-gray-500 hover:bg-gray-900 hover:text-white bg-white shadow-md rounded-md p-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                    </svg>
                                    <span class="lg:text-sm text-base">Join Contributor</span>
                                </a>
                            </div>
                        </div>
                    </div>
